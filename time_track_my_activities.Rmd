...
Now let's have a look at the time trends of activities. Which month, day, or week have been the most/least active ones? First I am going to add some new columns to activities table, to include day of the month, week number and month name to be used to look more into temporal trends. 

SOME TEXT THAT I ADDED TO MAKE THE WORKING DIRECTORY MESSY !
